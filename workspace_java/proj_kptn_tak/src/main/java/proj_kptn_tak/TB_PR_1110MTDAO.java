...
public class TB_PR_1110MTDAO {
    ...
    // 데이터 조회 (Select)
    public TB_PR_1110MTDTO select(String prodPlnCd) {
        System.out.println("TB_PR_1110MTDAO select 실행");
        TB_PR_1110MTDTO dto = null;
        ...
        try {
            ...
            // [SQL 준비]
            String query = "SELECT * FROM TB_PR_1110MT WHERE PROD_PLN_CD = ?";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setString(1, prodPlnCd);
    ...
    public List<TB_PR_1110MTDTO> selectAll() {
        System.out.println("TB_PR_1110MTDAO selectAll 실행");
        List<TB_PR_1110MTDTO> list = new ArrayList<>();
    ...
    // 데이터 삭제 (Delete)
    public int delete(String prodPlnCd) {
        System.out.println("TB_PR_1110MTDAO delete 실행");
        int result = -1;
        ...
        try {
            ...
            // [SQL 준비]
            String query = "DELETE FROM TB_PR_1110MT WHERE PROD_PLN_CD = ?";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setString(1, prodPlnCd);
